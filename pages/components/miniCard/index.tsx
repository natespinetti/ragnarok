...
export const MiniCard = ({ fields }: TypeMiniCard) => { 
  ...
  return (
      <Box display="block" w="100%" alignItems="center">
          <Box pos="relative">
            <Link href={link} w="100%" display="flex" justifyContent="center" alignItems="center" onMouseOver={over} onMouseOut={out} mb={{base: '6', xl: '0'}}>
          ...
          <Box pos="relative" pt="1rem">
            ...
            {link ? (
              <Link href={link} w={{base: '100%', xl: 'fit-content'}} display="grid" onMouseOver={over} onMouseOut={out} mb={{base: '6', xl: '0'}}>
